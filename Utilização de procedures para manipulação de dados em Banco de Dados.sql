...
create procedure product_procedure(
	in option_p tinyint(1),
    in idProduct_p int,
	in Pname_p varchar(45),
...
call product_procedure(2, null, "Carrinho", 1, "Brinquedos", 4, "2x5x10", "Carrinho de brinquedo", 50.3);

-- Atualizar descrição do produto de id 2
call product_procedure(3, 2, null, null, null, null, null, "Boneca", null);
-- Atualizar descrição e preço de produto de id 6
call product_procedure(3, 6, null, null, null, null, null, "Alimento - farinha de arroz", 12.0);
